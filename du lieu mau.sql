...
insert into MONHOC(MaMonHoc, TenMonHoc, MaLoaiMon, SoTiet) values ('SS008', N'KTCT Mác-Lênin', 'LT', '30')
insert into MONHOC(MaMonHoc, TenMonHoc, MaLoaiMon, SoTiet) values ('SS009', N'CNXHKH', 'LT', '30')
insert into MONHOC(MaMonHoc, TenMonHoc, MaLoaiMon, SoTiet) values ('SS003', N'Tư tưởng Hồ Chí Minh', 'LT', '30')
insert into MONHOC(MaMonHoc, TenMonHoc, MaLoaiMon, SoTiet) values ('SS010', N'Lịch sử ĐCSVN', 'LT', '30')
