...
{
    public class DSSV_CHUAHOANTHANH_HPsController : Controller
    {
        private CNPM_DBContext db = new CNPM_DBContext();

        // GET: PDT/DSSV_CHUAHOANTHANH_HPs
        public ActionResult Index()
        {
            var dSSV_CHUAHOANTHANH_HP = db.DSSV_CHUAHOANTHANH_HPs.Include(d => d.HKNH).Include(d => d.SINHVIEN);
            return View(dSSV_CHUAHOANTHANH_HP.ToList());
        }

        // GET: PDT/DSSV_CHUAHOANTHANH_HPs/Details/5
        public ActionResult Details(int? id)
        {
            ...
            DSSV_CHUAHOANTHANH_HP dSSV_CHUAHOANTHANH_HP = db.DSSV_CHUAHOANTHANH_HPs.Find(id);
        ...
        // GET: PDT/DSSV_CHUAHOANTHANH_HPs/Create
        ...
        // POST: PDT/DSSV_CHUAHOANTHANH_HPs/Create
        ...
        public ActionResult Create([Bind(Include = "MaHKNH,MaSV,SoTienConLai")] DSSV_CHUAHOANTHANH_HP dSSV_CHUAHOANTHANH_HP)
        {
            ...
            {
                db.DSSV_CHUAHOANTHANH_HPs.Add(dSSV_CHUAHOANTHANH_HP);
                db.SaveChanges();
        ...
        // GET: PDT/DSSV_CHUAHOANTHANH_HPs/Edit/5
        ...
        // POST: PDT/DSSV_CHUAHOANTHANH_HPs/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: PDT/DSSV_CHUAHOANTHANH_HPs/Delete/5
        ...
        // POST: PDT/DSSV_CHUAHOANTHANH_HPs/Delete/5
        [HttpPost, ActionName("Delete")]
        [ValidateAntiForgeryToken]
        public ActionResult DeleteConfirmed(int id)
        {
            DSSV_CHUAHOANTHANH_HP dSSV_CHUAHOANTHANH_HP = db.DSSV_CHUAHOANTHANH_HPs.Find(id);
            db.DSSV_CHUAHOANTHANH_HPs.Remove(dSSV_CHUAHOANTHANH_HP);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
