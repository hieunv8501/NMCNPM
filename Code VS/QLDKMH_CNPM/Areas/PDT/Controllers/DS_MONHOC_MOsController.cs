...
{
    public class DS_MONHOC_MOsController : Controller
    {
        private CNPM_DBContext db = new CNPM_DBContext();

        // GET: PDT/DS_MONHOC_MOs
        public ActionResult Index()
        {
            var dS_MONHOC_MO = db.DS_MONHOC_MOs.Include(d => d.HKNH).Include(d => d.MONHOC);
            return View(dS_MONHOC_MO.ToList());
        }

        // GET: PDT/DS_MONHOC_MOs/Details/5
        public ActionResult Details(string id)
        {
            ...
            DS_MONHOC_MO dS_MONHOC_MO = db.DS_MONHOC_MOs.Find(id);
        ...
        public ActionResult Create([Bind(Include = "MaMo,MaHKNH,MaMonHoc")] DS_MONHOC_MO dS_MONHOC_MO)
        {
            ...
            {
                db.DS_MONHOC_MOs.Add(dS_MONHOC_MO);
                db.SaveChanges();
        ...
        // GET: PDT/DS_MONHOC_MOs/Delete/5
        ...
        // POST: PDT/DS_MONHOC_MOs/Delete/5
        [HttpPost, ActionName("Delete")]
        [ValidateAntiForgeryToken]
        public ActionResult DeleteConfirmed(string id)
        {
            DS_MONHOC_MO dS_MONHOC_MO = db.DS_MONHOC_MOs.Find(id);
            db.DS_MONHOC_MOs.Remove(dS_MONHOC_MO);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
