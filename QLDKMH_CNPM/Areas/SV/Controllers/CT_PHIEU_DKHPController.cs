...
namespace QLDKMH_CNPM.Areas.SV.Controllers
{
    public class CT_PHIEU_DKHPController : Controller
    {
        ...
        public ActionResult DeleteConfirmed(FormCollection formCollection)
        {
            ...
            {
<<<<<<< HEAD:Code VS/QLDKMH_CNPM/Areas/SV/Controllers/CT_PHIEU_DKHPController.cs
                ViewBag.Message = "Sai";
                return RedirectToAction("Details", "Phieu_DKHP", new { id = int.Parse(formCollection["SoPhieuDKHP"]) });
=======
                return RedirectToAction("Delete", "CT_PHIEU_DKHP", new { id_PhieuDKHP = id_PhieuDKHP, id_MaMo = id_MaMo, code = 1 });
>>>>>>> 657df6fe0b310eaadbd63847b1489c0402a8ba69:QLDKMH_CNPM/Areas/SV/Controllers/CT_PHIEU_DKHPController.cs
            }
        }
