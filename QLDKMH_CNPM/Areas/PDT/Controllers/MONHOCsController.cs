                ...
                if ((file != null) && (file.ContentLength > 0) && !string.IsNullOrEmpty(file.FileName))
                {
                    ...
                    using (var package = new ExcelPackage(file.InputStream))
                    {
                        ...
                        for (int iRow = 2; iRow <= SL_Row; iRow++)
                        {
                            ...
                            monhoc.MaMonHoc = workSheet.Cells[iRow, 1].Value.ToString();
                            monhoc.TenMonHoc = workSheet.Cells[iRow, 2].Value.ToString();
                            monhoc.MaLoaiMon = workSheet.Cells[iRow, 3].Value.ToString();
                            monhoc.SoTiet = Convert.ToInt32(workSheet.Cells[iRow, 4].Value.ToString());
                            mONHOC.Add(monhoc);
                        }
                    }
                }
